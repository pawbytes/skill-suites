...
def parse_args():
    ...
    parser.add_argument(
        "--config-path",
        required=True,
        help="Path to the target .pawbytes/config/config.yaml file",
    )
    parser.add_argument(
        "--module-yaml",
        required=True,
    ...
    parser.add_argument(
        "--user-config-path",
        required=True,
        help="Path to the target .pawbytes/config/config.user.yaml file",
    )
    parser.add_argument(
        "--legacy-dir",
        help="Path to .pawbytes/ directory to check for legacy per-module config files. "
