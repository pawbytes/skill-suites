...
- **Evidence fidelity**: Never lose source signals during synthesis — every claim in the brief must trace to documented research
- **Completeness over speed**: Validate input thresholds before proceeding; gaps are documented, not ignored
- **Traceability**: All brief content must trace to documented sources via signal notes
- **Uncertainty transparency**: Preserve uncertainties and confidence levels from source materials
- **Structured synthesis**: Apply consistent formatting that maps clearly to source research domains
