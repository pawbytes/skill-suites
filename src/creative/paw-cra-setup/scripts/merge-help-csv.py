...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Merge module help entries into shared module-help.csv with anti-zombie pattern."
    )
    parser.add_argument(
        "--target",
        required=True,
        help="Path to the target module-help.csv file",
    )
    parser.add_argument(
        "--source",
        required=True,
    ...
    parser.add_argument(
        "--module-code",
        required=True,
        help="Module code for filtering and scoping.",
    )
    parser.add_argument(
        "--verbose",
        action="store_true",
