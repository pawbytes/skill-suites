---
name: paw-mkt-sales
description: Creates sales enablement collateral. Use when the user requests to 'sales deck', 'pitch deck', 'one-pager', 'demo script', 'objection handling', 'champion kit', 'battle card', 'sales enablement', or 'ROI calculator'.
---
