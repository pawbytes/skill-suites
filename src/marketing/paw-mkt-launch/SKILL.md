---
name: paw-mkt-launch
description: "Plans and executes product launches with phased channel strategies. Use when the user requests to 'product launch', 'GTM', 'go-to-market', 'Product Hunt', 'beta launch', 'early access', or 'launch checklist'."
---
