...
> Sources: Product Hunt official launch guides, top-performing PH launches analysis, practitioner post-mortems from Indie Hackers and First Round Review.

---

## 1. Is Product Hunt Right for This Launch?
...
## 2. Pre-Launch Preparation (T-4 to T-2 weeks)
...
- Send a personal, non-spammy outreach explaining: what you are launching, why it matters, when the launch is, and the exact simple action to take.
...
## 6. Product Hunt Gallery Checklist

See `./references/launch-checklist.md` Section 4 (Per-Channel Content Checklist > Product Hunt) for the full asset checklist and quality checks.
