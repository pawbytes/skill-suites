...
description: Generates SvelteKit + sql.js dashboards with LLM-built UI. Use when the user requests to 'marketing dashboard', 'campaign tracker', 'marketing tracker', or 'build dashboard'.
---
